...
extern json_spirit::Value getdifficultym(const json_spirit::Array& params, bool fHelp);
...
extern json_spirit::Value setstakecombinethreshold(const json_spirit::Array& params, bool fHelp);
